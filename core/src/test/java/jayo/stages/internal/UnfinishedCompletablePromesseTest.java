...
public class UnfinishedCompletablePromesseTest extends AbstractUnfinishedCompletionStageTest {
    ...
    private static class DelayedSimpleCompletionStage extends RealPromesse<String> {
        ...
        private DelayedSimpleCompletionStage(Consumer<DelayedSimpleCompletionStage> delayedAction, Executor defaultExecutor) {
            super(defaultExecutor, null, true);
